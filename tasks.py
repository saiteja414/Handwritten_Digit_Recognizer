...
def taskCifar10():	
	...
	nn1 = nn.NeuralNetwork(10, 0.1, 20, 15)
	nn1.addLayer(ConvolutionLayer([3,32,32], [15,15], 7, 3))
	nn1.addLayer(FlattenLayer())
	nn1.addLayer(FullyConnectedLayer(6*6*7,40))
